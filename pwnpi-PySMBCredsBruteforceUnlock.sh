...
python3 mmcbrute.py -t 172.16.0.2 -u $user_bruteforce_list -p $pass_bruteforce_list 2> $password_process_file
sed -i -e 's/\x1B[@A-Z\\\]^_]\|\x1B\[[0-9:;<=>?]*[-!"#$%&'"'"'()*+,.\/]*[][\\@A-Z^_`a-z{|}~]//g' $password_process_file
